    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card shadow mb-4">
                <form action="<?= base_url('add-gejala') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="text" class="form-control form-control-user" name="kd1" id="kd1" readonly value="G00">
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            <div class="col mb-3 mb-sm-0">
                                <input type="text" class="form-control form-control-user" name="nama_gj" id="nama_gj" placeholder="Gejala"><?= form_error('nama_gj', '<small class="text-danger pl-3">', '</small>') ?>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6">

            ...
            <div class="card shadow mb-4">
                <form action="<?= base_url('add-artikel') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <img src="<?= base_url('assets/admin/img/default.png') ?>" width="500" id="image-prev" class="img-thumbnails" alt="">
                                <p></p>
                    ...
                    <div class="card-footer">
                        <div class="text-right">
                            <button class="btn btn-primary btn-user" type="submit">Simpan Data</button>

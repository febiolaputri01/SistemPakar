    ...
    <div class="col-lg-8 mt-5 mt-lg-0 d-flex align-items-stretch">
        <div class="php-email-form">
            <div class="section-title">
                ...
                <img class="img-fluid" src="<?= base_url('/assets/template/img/articles/'.$artikel['gambar'])?>">
                <p></p>
                <?=$artikel['isi']?>
        </div>
    </div>
...
<div class="col-lg-4 mt-5 mt-lg-0 d-flex align-items-stretch">
    ...
    <h4>Artikel Lainnya</h4>
        <figure class="text-end"><h6><a href="<?=base_url('artikel')?>">Seluruh Artikel</a></h6></figure>
...
if($artikel['id_artikel']!=$lainnya->id_artikel):?>
    ...
    <a href="<?=base_url('home/article_read/'.$lainnya->id_artikel)?>">
        <img class="img-fluid" src="<?= base_url('/assets/template/img/articles/'.$lainnya->gambar)?>">
    </a>
    <a href="<?=base_url('artikel/article_read/'.$lainnya->id_artikel)?>">

  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              ...
              <p>
                ...
                Teknologi Informasi, Teknik Informatika<br><br>
                <strong>Phone:</strong> +62 8155 9855 799<br>
                <strong>Email:</strong> febiolaputri01@gmail.com<br>
              </p>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Cara Deteksi</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Tentang</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Deteksi Dini</a></li>
            </ul>
          </div>
         ...
         <!--    <h4>Our Services</h4>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            <h4>Beri Pertanyaan dan saran</h4>
            <p>Silahkan berikan pertanyaan dan saran membangun agar sistem pakar ini menjadi lebih baik</p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Exsisispa</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Dikembangkan oleh <a href="https://bootstrapmade.com/">TIF Polije</a>
      </div>
    </div>
  </footer><!-- End Footer -->

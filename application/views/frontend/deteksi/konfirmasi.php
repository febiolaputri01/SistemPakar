            ...
            <div class="p-5">
              ...
              <table>
                <tbody>
                  <tr>
                    <?php
                      $_SESSION['pasien'] = $who['id_deteksi_pasien'];
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p><b>Deteksi dini yang akan dilakukan adalah deteksi dini terhadap penyakit ISPA antara lain : </b></p>
        <p style="color: red;"><b>PNEUMONIA, DIFTERI, TUBERCULOSIS, DAN COVID-19.</b> </p>
        <P><b>Proses deteksi dini ini menggunakan metode Forward Chaining dan Certainty Factor, dan hasil yang didapatkan tidak bersifat mutlak, jika anda teridentifikasi penyakit ISPA maka perlu untuk segera konsultasikan ke dokter specialis Paru-paru</b></P>
      </div>

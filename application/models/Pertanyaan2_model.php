...
class Pertanyaan2_model extends CI_Model {
    ...
    {
    	 $this->db->select(
            'a.id_pertanyaan, a.id_pertanyaan_grup, a.pertanyaan, a.jawaban_1,  a.jawaban_2,  a.jawaban_3,  a.jawaban_4,
            b.id_gejala as id1, b.kode_gejala as kode1, b.nama_gejala as nama1, b.image_gejala as image1, c.id_gejala as id2, c.kode_gejala as kode2, c.nama_gejala as nama2, c.image_gejala as image2, d.id_gejala as id3, d.kode_gejala as kode3, d.nama_gejala as nama3, d.image_gejala as image3, e.id_gejala as id4, e.kode_gejala as kode4, e.nama_gejala as nama4, e.image_gejala as image4, f.id_pertanyaan_grup, f.nama_pertanyaan_grup'
        );
        $this->db->from('tb_pertanyaan2 a');
        $this->db->join('tb_gejala b', 'a.jawaban_1 = b.id_gejala');
        $this->db->join('tb_gejala c', 'a.jawaban_2 = c.id_gejala');
        $this->db->join('tb_gejala d', 'a.jawaban_3 = d.id_gejala');
        $this->db->join('tb_gejala e', 'a.jawaban_4 = e.id_gejala');
        $this->db->join('pertanyaan_grup f', 'a.id_pertanyaan_grup = f.id_pertanyaan_grup');
